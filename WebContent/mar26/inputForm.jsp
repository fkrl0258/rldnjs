...
<div id="wrap">
	<form action="inputPro.jsp" name="userinput" onsubmit="return checkIt()" method="post">
		<h1>★회원가입★</h1>
		<div id="body">
				<table width="500px;"> <!-- table을 만드는 태크 -->
					<colgroup>
						<col width="20%" />
						<col width="*" />
					</colgroup>
					...
					<tr>
						<th>사용자 ID</th> <!-- 테이블의 행,열의 머리말(table heading)을 나타낸다. 기본적으로 가운데 정렬되고 굵은 글씨로 표시된다. -->
						<td> <!-- 표의 내용을(table data) 셀을 표현한다. -->
							<input type="text" name="id" maxlength="12" /> <!-- 입력값 요소를 지정한다.type에 따라 다른 입력값을 취한다. -->
