...
<form method="post" action="modifyPro.jsp" name="userinput" onsubmit="return checkIt()">
	...
	<tr>
		<td width="200" bgcolor="<%=value_c %>"><b>아이디를 입력</b></td>
...
<%}%>		
	...
	<tr>
		<td colspan="2" align="center" bgcolor="<%=value_c %>">
			...
			<input type="button" value="취  소" onclick="javascript:window.locaion='main.jsp'">
		</td>
	</tr>
</table>
</form>
